...
// DW MMC Registers
#define DWSD_CTRL		(mDwSdRegisterBase + 0x000)
#define DWSD_PWREN		(mDwSdRegisterBase + 0x004)
#define DWSD_CLKDIV		(mDwSdRegisterBase + 0x008)
#define DWSD_CLKSRC		(mDwSdRegisterBase + 0x00c)
#define DWSD_CLKENA		(mDwSdRegisterBase + 0x010)
#define DWSD_TMOUT		(mDwSdRegisterBase + 0x014)
#define DWSD_CTYPE		(mDwSdRegisterBase + 0x018)
#define DWSD_BLKSIZ		(mDwSdRegisterBase + 0x01c)
#define DWSD_BYTCNT		(mDwSdRegisterBase + 0x020)
#define DWSD_INTMASK		(mDwSdRegisterBase + 0x024)
#define DWSD_CMDARG		(mDwSdRegisterBase + 0x028)
#define DWSD_CMD		(mDwSdRegisterBase + 0x02c)
#define DWSD_RESP0		(mDwSdRegisterBase + 0x030)
#define DWSD_RESP1		(mDwSdRegisterBase + 0x034)
#define DWSD_RESP2		(mDwSdRegisterBase + 0x038)
#define DWSD_RESP3		(mDwSdRegisterBase + 0x03c)
#define DWSD_RINTSTS		(mDwSdRegisterBase + 0x044)
#define DWSD_STATUS		(mDwSdRegisterBase + 0x048)
#define DWSD_FIFOTH		(mDwSdRegisterBase + 0x04c)
#define DWSD_TCBCNT		(mDwSdRegisterBase + 0x05c)
#define DWSD_TBBCNT		(mDwSdRegisterBase + 0x060)
#define DWSD_DEBNCE		(mDwSdRegisterBase + 0x064)
#define DWSD_UHSREG		(mDwSdRegisterBase + 0x074)
#define DWSD_BMOD		(mDwSdRegisterBase + 0x080)
#define DWSD_DBADDR		(mDwSdRegisterBase + 0x088)
#define DWSD_IDSTS		(mDwSdRegisterBase + 0x08c)
#define DWSD_IDINTEN		(mDwSdRegisterBase + 0x090)
#define DWSD_DSCADDR		(mDwSdRegisterBase + 0x094)
#define DWSD_BUFADDR		(mDwSdRegisterBase + 0x098)
#define DWSD_CARDTHRCTL		(mDwSdRegisterBase + 0x100)
#define DWSD_FIFO_START         (mDwSdRegisterBase + 0x200)
