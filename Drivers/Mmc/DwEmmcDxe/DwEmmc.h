...
// DW MMC Registers
#define DWEMMC_CTRL		(mDwEmmcRegisterBase + 0x000)
#define DWEMMC_PWREN		(mDwEmmcRegisterBase + 0x004)
#define DWEMMC_CLKDIV		(mDwEmmcRegisterBase + 0x008)
#define DWEMMC_CLKSRC		(mDwEmmcRegisterBase + 0x00c)
#define DWEMMC_CLKENA		(mDwEmmcRegisterBase + 0x010)
#define DWEMMC_TMOUT		(mDwEmmcRegisterBase + 0x014)
#define DWEMMC_CTYPE		(mDwEmmcRegisterBase + 0x018)
#define DWEMMC_BLKSIZ		(mDwEmmcRegisterBase + 0x01c)
#define DWEMMC_BYTCNT		(mDwEmmcRegisterBase + 0x020)
#define DWEMMC_INTMASK		(mDwEmmcRegisterBase + 0x024)
#define DWEMMC_CMDARG		(mDwEmmcRegisterBase + 0x028)
#define DWEMMC_CMD		(mDwEmmcRegisterBase + 0x02c)
#define DWEMMC_RESP0		(mDwEmmcRegisterBase + 0x030)
#define DWEMMC_RESP1		(mDwEmmcRegisterBase + 0x034)
#define DWEMMC_RESP2		(mDwEmmcRegisterBase + 0x038)
#define DWEMMC_RESP3		(mDwEmmcRegisterBase + 0x03c)
#define DWEMMC_RINTSTS		(mDwEmmcRegisterBase + 0x044)
#define DWEMMC_STATUS		(mDwEmmcRegisterBase + 0x048)
#define DWEMMC_FIFOTH		(mDwEmmcRegisterBase + 0x04c)
#define DWEMMC_DEBNCE		(mDwEmmcRegisterBase + 0x064)
#define DWEMMC_UHSREG		(mDwEmmcRegisterBase + 0x074)
#define DWEMMC_BMOD		(mDwEmmcRegisterBase + 0x080)
#define DWEMMC_DBADDR		(mDwEmmcRegisterBase + 0x088)
#define DWEMMC_IDSTS		(mDwEmmcRegisterBase + 0x08c)
#define DWEMMC_IDINTEN		(mDwEmmcRegisterBase + 0x090)
#define DWEMMC_DSCADDR		(mDwEmmcRegisterBase + 0x094)
#define DWEMMC_BUFADDR		(mDwEmmcRegisterBase + 0x098)
#define DWEMMC_CARDTHRCTL	(mDwEmmcRegisterBase + 0X100)
